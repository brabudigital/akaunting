...
return [
    ...
    "over_payment" =>
        "Het bedrag dat je hebt ingevoerd, komt voorbij het totaal:",

    "form_description" => [
        "billing" =>
            "Factuurgegevens verschijnen op uw factuur. Factuurdatum wordt gebruikt in het dashboard en in rapporten. Selecteer de datum waarop u verwacht betaald te worden als vervaldatum.",
    ],

    "messages" => [
        "email_required" => "Er is geen e-mailadres bekend van deze klant!",
        "totals_required" =>
            "Factuurtotalen zijn vereist Bewerk het :type en sla het opnieuw op.",

        "draft" =>
            "Dit is een <b>CONCEPT</b> factuur en zal terugkomen in de statistieken wanneer het verzonden is.",
        ...
        "name_or_description_required" =>
            "Je factuur moet ten minste één van de volgende punten bevatten <b>:name</b> of <b>:description</b>.",
    ],
    ...
    "sticky" => [
        "description" =>
            "Je bekijkt hoe je klant de webversie van je factuur zal zien.",
    ],
];
